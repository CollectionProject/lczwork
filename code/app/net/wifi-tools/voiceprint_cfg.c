...
struct vp_cfg {
    ...
    u8 us_ssid[US_STA_NAME_LEN];
    u8 us_pwd[US_STA_PWD_LEN];
...
static int const coeff[TotalFreq] = {
    //48000
    -3242240,//18750.000000Hz
    -3175964,//18562.500000Hz
    -3107774,//18375.000000Hz
    -3037712,//18187.500000Hz
    -2965820,//18000.000000Hz
    -2892142,//17812.500000Hz
    -2816722,//17625.000000Hz
    -2739605,//17437.500000Hz
    -2660838,//17250.000000Hz
    -2580468,//17062.500000Hz
    -2498543,//16875.000000Hz
    -2415114,//16687.500000Hz
    -2330230,//16500.000000Hz
    -2243942,//16312.500000Hz
    -2156303,//16125.000000Hz
    -2067364,//15937.500000Hz
    -1977181,//15750.000000Hz
};
        ...
        case OS_TASKQ:
            ...
            case Q_USER:
                ...
                case US_WIFI_SUCC:
                    ...
                    wifi_smp_connect(vp_cfg->us_ssid, vp_cfg->us_pwd, vp_cfg->us_random);
                /*break;*/
...
static struct audio_vfs_ops audio_vfs_ops = {
    .fwrite = vfs_fwrite,
    .fclose = vfs_fclose,
};
...
static int aud_rec_start()
{
    ...
    req.enc.output_buf_len = 100 * 1024;
...
int voiceprint_cfg_start(void)
{
    ...
    thread_fork(VOICE_PRINT_TASK_NAME, 10, 0x1000, 32, &vp_cfg->pid, us_task, NULL);
