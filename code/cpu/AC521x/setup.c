...
{
#if 1
    xbus_ch01_lvl = 0; //isp0 stc wr
    xbus_ch03_lvl = 3; //imc ch0 wr encode
    xbus_ch04_lvl = 3; //imc ch1 wr encode
    xbus_ch05_lvl = 0; //imc ch2 wr
    xbus_ch06_lvl = 0; //imc ch3 wr
    xbus_ch07_lvl = 0; //imr0 wr
    xbus_ch08_lvl = 0; //imr1 wr
    xbus_ch09_lvl = 0; //imb wr
    xbus_ch10_lvl = 0; //imc ch4 wr

    xbus_ch18_lvl = 0; //imc replay
    xbus_ch19_lvl = 3; //imc ch0 osd
    xbus_ch20_lvl = 3; //imc ch1 osd
    xbus_ch23_lvl = 0; //imr0 rd
    xbus_ch24_lvl = 0; //imr1 rd
    xbus_ch25_lvl = 0; //imb rd
    xbus_ch26_lvl = 0; //imd rd
