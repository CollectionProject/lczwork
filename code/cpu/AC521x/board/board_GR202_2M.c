...
WIFI_PLATFORM_DATA_BEGIN(wifi_data)
    .module = RTL8189E,
    .sdio_parm = SDIO_GRP_1 | SDIO_PORT_2 | SDIO_4_BIT_DATA | SDIO_CLOCK_26M,
...
void debug_uart_init()
{
	...
	IOMC1 &= ~(0x0f << 8);
    IOMC1 |= (0x2 << 8);
    gpio_direction_output(uart2_data.tx_pin, 0);
    gpio_set_pull_up(uart2_data.tx_pin, 1);
    gpio_set_pull_down(uart2_data.tx_pin, 1);
    gpio_set_die(uart2_data.tx_pin, 0);
