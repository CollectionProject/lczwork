...
C:\JL\pi32\bin/llvm-objcopy -O binary -j .data main.or32 data.bin
...
copy  sdram_text.bin /b + data.bin /b + ram0_data.bin /b + ram2_data.bin /b  sdram.bin

C:\JL\pi32\bin/llvm-objdump -h  main.or32

call ÏÂÔØ´úÂë-tosfc-2M_SDRAM.bat
