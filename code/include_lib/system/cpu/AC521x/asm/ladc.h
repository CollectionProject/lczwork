...
int dv15_adc_open(int sample_rate, int channel, u8 ldo_sel);


int dv15_adc_set_sample_rate(int sample_rate);
...
void dv15_adc_set_data_handler(void *priv, void (*handler)(void *, u8 *data, int len));

int dv15_adc_set_gain(u8 gain_val);
