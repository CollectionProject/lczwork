...
void *image_enc_open(struct video_format *f, u8 multi_scale);
void *image_enc_force_open(struct video_format *f, u8 multi_scale, int id);
int image_enc_set_fmt(void *_fh, struct video_format *f, u8 multi_scale);
