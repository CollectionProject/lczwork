...
struct usb_hid_arg {
    ...
    int kb_state;
    void *cbuf;
    u32(*get_one_frame)(struct usb_hid_arg *, u8 *buf, u32 len);
...
/***********2018-06-21************/
#define USBIOC_GET_MANUFACTURER         _IOR('U', 17, sizeof(struct usb_string))
#define USBIOC_GET_PRODUCT_NAME         _IOR('U', 18, sizeof(struct usb_string))
/*********************************/
/***********2018-07-30************/
#define UVCIOC_SET_EVENT_LISTENER       _IOW('U', 19, sizeof(struct uvc_event_listener))
/*********************************/

#define USBIOC_HID_CONNECT              _IOW('U', 19, sizeof(struct usb_hid_arg))
#define USBIOC_HID_CONTROL              _IOW('U', 20, sizeof(struct usb_hid_arg))
