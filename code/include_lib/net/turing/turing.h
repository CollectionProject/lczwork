...
enum {
    ...
    TURING_EVENT_START,
    TURING_EVENT_STOP,
    TURING_EVENT_NLP_URL,
    TURING_EVENT_ERR_SEND,
    TURING_EVENT_ERR_CODE,
...
int turing_recorder_start(u16 sample_rate);
int turing_recorder_stop(void);
void JL_turing_media_speak_play(const char *url);
void JL_turing_media_audio_play(const char *url);
void JL_turing_wechat_speak_play(const char *url);
