...
#include "HSM/hsm.h"
#include "wifi_module/wifi_module_event.h"
...
int set_airkiss_key(const unsigned char *key);
void set_airkiss_aes_enable(u32 enable);
int get_monitor_result(struct smp_cfg_result *smp_cfg);
