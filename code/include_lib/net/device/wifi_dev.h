...
|DEV_SET_SMP_AIRKISS_KEY  		 |aes_key          |NULL 		     |
|DEV_SET_SMP_AIRKISS_AES_ON_OFF  |1:on 	0:off      |NULL 		     |
*/
...
enum {
    ...
    DEV_SET_SMP_AIRKISS_KEY,	//设置AIRKISS的AES密钥
    DEV_SET_SMP_AIRKISS_AES_ON_OFF,	//打开或关闭AIRKISS的AES解密功能
};
